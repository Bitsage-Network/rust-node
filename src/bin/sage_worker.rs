...
async fn run_worker(config: WorkerConfig, vllm_endpoint: Option<String>) -> Result<()> {
    ...
    let capabilities = WorkerCapabilities {
        ...
        supported_job_types: vec![
            "AIInference".to_string(),
            "ModelInference".to_string(),
            "BatchInference".to_string(),
            "ModelDeploy".to_string(),
            ...
            "NLP".to_string(),
            "VideoProcessing".to_string(),
            "Render3D".to_string(),
            "DataPipeline".to_string(),
            "STWOProof".to_string(),
            "ZKProof".to_string(),
            "ObelyskProof".to_string(),
            "FHECompute".to_string(),
            "ConfidentialAI".to_string(),
            "ConfidentialVM".to_string(),
        ],
